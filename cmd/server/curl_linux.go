...
func (t *curlTransport) RoundTrip(r *http.Request) (*http.Response, error) {
	...
	var out C.buf
	var st C.long
	e := C.run(u, m, b, p, a, 120000, &out, &st)
	if e != C.CURLE_OK {
